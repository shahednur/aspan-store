...
export default function Header({setShow, show, showWish, setShowWish}) {
                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
                        ...
                        <div className="hidden md:block">
                            <ul className="flex items-center space-x-6">
                                <li>
                                    <a href="/" className="dark:text-white dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        {" "}
                                        New{" "}
                                    </a>
                                </li>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <a aria-label="my account" href="/" className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                            ...
                            <div onClick={() => setShowWish(!showWish)} aria-label="Favourites" className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                            ...
                            <div onClick={() => setShow(!show)} aria-label="Bag"  className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                ...
                <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} dark:bg-gray-900 md:hidden absolute inset-0 z-10 flex-col w-full h-screen bg-white pt-6`}>
                    ...
                    <div className="mt-4 mx-4">
                        <ul className="flex flex-col space-y-4">
                            <li className="border-b border-gray-200 dark:border-gray-700 dark:text-gray-700 pb-4 px-1 flex items-center justify-between">
                                <a href="/" className="dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline">
                                    {" "}
                                    New{" "}
                                </a>
                    ...
                    <div className="w-full h-full flex items-end">
                        <ul className="bg-gray-50 dark:bg-gray-800 py-10 px-4 flex flex-col space-y-8 w-full">
                            <li>
                                <a className="flex items-center space-x-2 focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline" href="/">
                                    <div>
                            ...
                            <li>
                                <div onClick={() => setShow(!show)} className="flex items-center space-x-2 focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">
                                    <div>
