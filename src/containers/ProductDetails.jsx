...
const ProductDetails = ({showWish}) => {
    ...
    useEffect(() => {
        if(id && id !== "") fetchProductsDetails(id);
        return () => {
    ...
    //create a function of add to cart
    const addToCartHandler = () => {
        dispatch(addToCart(products, counts));
    }

    //create a function for price calculation according to quantity
    const priceCalculation = (price, quantity) => {
        let totalPrice = price * quantity;
        return totalPrice;
    }

    //create a function for adding to wishlist
    const addToWishlist = () => {
        ...
        wishlist.push({
            ...
            price: price,
            quantity: counts,
            totalPrice: priceCalculation(price, counts),
        });
        localStorage.setItem("wishlist", JSON.stringify(wishlist));
    }

    //create a function for adding to compare
    const addToCompare = () => {
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">Home / {category} / {shortenTitle(title)}</p>
                    ...
                    <div className="lg:mt-11 mt-10">
                        <div className="flex flex-row justify-between">
                            ...
                            <div className="flex">
                                ...
                                <input id="counter" aria-label="input" className="border border-gray-300 h-full text-center w-14 pb-1" type="text" value={counts} onChange={(e) => e.target.value} />
                        ...
                        <div className=" flex flex-row justify-between items-center mt-4">
                            <p className="font-medium text-base leading-4 text-gray-600">Total Amount:</p>
                            <p className="font-medium text-base leading-4 text-gray-600">$ {priceCalculation(price, counts)}</p>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    ...
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src={image} alt="Wooden chair - preview 2" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
